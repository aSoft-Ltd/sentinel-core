...
subprojects {
    ...
    configure<MavenPublishBaseExtension> {
        ...
        pom {
            ...
            url.set("https://github.com/aSoft-Ltd/sentinel-api")
            licenses {
                license {
                    name.set("MIT License")
                    url.set("https://github.com/aSoft-Ltd/sentinel-api/blob/master/LICENSE")
                }
            }
            developers {
                developer {
            ...
            scm {
                url.set("https://github.com/aSoft-Ltd/sentinel-api/")
                connection.set("scm:git:git://github.com/aSoft-Ltd/sentinel-api.git")
                developerConnection.set("scm:git:ssh://git@github.com/aSoft-Ltd/sentinel-api.git")
            }
        }
    }
}
